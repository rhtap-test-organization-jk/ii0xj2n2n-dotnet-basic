...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/ii0xj2n2n-dotnet-basic-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-vx285.vx285.sandbox449.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-vx285.vx285.sandbox449.opentlc.com}
